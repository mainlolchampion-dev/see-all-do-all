        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 max-w-5xl mx-auto">
          {rates.map((rate, index) => (
            <motion.div
              ...
              className={`rounded-xl p-6 text-center group transition-all duration-500 relative overflow-hidden border-2 ${goldStyle.border} ${goldStyle.bg} ${goldStyle.shadow} ${goldStyle.shadowHover}`}
            >
