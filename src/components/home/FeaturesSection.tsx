        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className={`relative z-10 w-14 h-14 rounded-xl ${goldStyle.iconBg} flex items-center justify-center mb-4 group-hover:scale-110 transition-all`}>
                <feature.icon className={`w-7 h-7 ${goldStyle.iconColor}`} />
              </div>
